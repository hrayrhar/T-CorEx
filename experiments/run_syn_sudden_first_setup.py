...
def main():
    ...
    exp_name = 'sudden_first_setup.{}.nt{}.m{}.bs{}.val_cnt{}.test_cnt{}.snr{:.2f}.min_std{:.2f}.max_std{:.2f}'.format(
        args.data_type, args.nt, args.m, args.bs, args.val_cnt, args.test_cnt,
